...
export interface SeriesListItemProps extends Pick<SeriesListProps, 'seriesValueFormatter' | 'seriesNameFormatter'> {
    seriesName?: CallbackSeriesDataPoint['seriesName'];
    data: CallbackSeriesDataPoint['data'];
    color: CallbackSeriesDataPoint['color'];
}
//# sourceMappingURL=SeriesListItem.types.d.ts.map
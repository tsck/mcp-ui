...
export interface ChartInstance extends EChartsInstance, Pick<ChartHookProps, 'enableGroupTooltipSync' | 'state'>, Pick<UseTooltipVisibilityReturnObj, 'isChartHovered' | 'setTooltipMounted' | 'tooltipPinned'> {
    id: string;
    ref: RefCallback<HTMLDivElement>;
}
//# sourceMappingURL=useChart.types.d.ts.map
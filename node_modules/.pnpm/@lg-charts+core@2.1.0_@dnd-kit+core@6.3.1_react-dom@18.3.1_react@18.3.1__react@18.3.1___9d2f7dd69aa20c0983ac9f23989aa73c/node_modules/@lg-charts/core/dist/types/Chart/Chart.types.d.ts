...
import { EChartOptions, EChartSeriesOption, EChartZoomSelectionEvent } from '../Echart';
...
export declare const ChartStates: {
...
export type ChartProps = React.ComponentPropsWithoutRef<'div'> & DarkModeProps & PropsWithChildren<{
    /**

 ...
 */
export declare const usePolymorphicRef: <E extends PolymorphicAs>(_?: E) => React.MutableRefObject<(E extends keyof HTMLElementTagNameMap ? HTMLElementTagNameMap[E] : unknown) | null>;
/**
 ...
 */
export declare function usePolymorphicComponent<T extends PolymorphicAs>(as?: T): PolymorphicAs;
/**
 * A hook that returns an accurately typed polymorphic `Component` and `ref`,
 * given an `as` prop
 */
export declare function usePolymorphic<T extends PolymorphicAs>(as?: T): {
    Component: PolymorphicAs;
    ref: PolymorphicRef<T>;
};
//# sourceMappingURL=Polymorphic.hooks.d.ts.map
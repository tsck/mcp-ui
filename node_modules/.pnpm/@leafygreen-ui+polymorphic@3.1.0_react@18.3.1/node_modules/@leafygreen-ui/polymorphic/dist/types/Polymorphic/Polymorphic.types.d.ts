 ...
 */
import { ComponentPropsWithoutRef, ComponentPropsWithRef, ElementType, FunctionComponent, PropsWithChildren, WeakValidationMap } from 'react';
...
export interface PolymorphicComponentType<XP = {}, DefaultAs extends PolymorphicAs = PolymorphicAs> {
    <T extends PolymorphicAs = DefaultAs>(props: PolymorphicPropsWithRef<T, XP>, ref: PolymorphicRef<T>): PolymorphicReturnType;
    displayName?: string;
